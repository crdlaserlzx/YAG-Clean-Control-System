...
#define  	SCS   PBout(8)     //5
#define  	SDO   PBin(9)     //6
#define  	SDI   PBout(10)     //7
#define  	SCLK  PBout(11)     //8
#define   next  PBin(12)	     //Ã¦Âµ×´Ì¬  9  1±íÊ¾Ã¦Âµ
#define   lcd_int   PBin(13)   //ÖÐ¶Ï  10
#define   lcd_reset PBout(14)  //Ó²¼þ¸´Î»  11

  
// #define  	SCLK  PDout(3)     //8
// #define  	SDI   PDout(2)     //7
// #define  	SDO   PDin(1)     //6
// #define  	SCS   PDout(0)     //5
// #define   next  PDin(4)	     //Ã¦Âµ×´Ì¬  9  1±íÊ¾Ã¦Âµ
// #define   lcd_int   PDin(5)   //ÖÐ¶Ï  10
// #define   lcd_reset PDout(6)  //Ó²¼þ¸´Î»  11
...
// void Delay1ms(u16 i);
// void Delay10ms(u16 i);
// void Delay100ms(u16 i);
...
// u8 * Number_To_Tab(float number);
// float Number_Input(u16 X,u16 Y);
...
// unsigned char  pic[31360] = {  0X10,0X10,0X00,0XB4,0X00,0X96,0X01,0X1B, 
...
// void Text_Background_Color1(u16 b_color);
// void Text_Background_Color(u8 setR, setG, setB);
// void Text_Foreground_Color1(u16 b_color);
// void Text_Foreground_Color(u8 setR,setG,setB);
// void BTE_Size(width,height);
// void BTE_Source(u16 SX,u16 DX ,u16 SY ,u16 DY);
// void MemoryWrite_Position(u16 X,u16 Y);
// void FontWrite_Position(u16 X,u16 Y);
// void String(u8 *str);
// void Scroll_Window(u16 XL,u16 XR ,u16 YT ,u16 YB);
...
// void TP(void);	
// void Displaypicture(u8 picnum);
// void CutPictrue(u8 picnum,u16 x1,u16 y1,u16 x2,u16 y2,unsigned long x,unsigned long y);
// void Test(void);
